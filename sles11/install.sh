#!/bin/bash
echo "This script will install the latest version of PowerShell Core on your SLES 11 system...."
echo .
...
zypper ar https://packages.microsoft.com/config/sles/11/prod.repo microsoft
